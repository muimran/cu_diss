...
d3.csv("data/top100_content_pub.csv").then((data) => {
  ...
  const logoPaths = {
    "BBC": "images/logo/bbc_logo.svg",
    "CNN": "images/logo/cnn_logo.svg",
    "foxnews": "images/logo/foxnews_logo.svg",
    "telegraph": "images/logo/telegraph_logo.svg",
    "Guardian": "images/logo/guardian_logo.svg",
    "New York Times": "images/logo/nytimes_logo.png",
    "Overall": "images/logo/all_outlets.svg"
  ...
  function initializeChart(defaultWord) {
    d3.csv("data/top1000_content_year.csv").then((fullData) => {
      ...
      Highcharts.chart("container", {
        chart: {
          type: "spline",
          backgroundColor: primaryColor, // Apply the primary color from your CSS
